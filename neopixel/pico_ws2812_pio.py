...
# Code above could be in a separate file, as shown in the original repository
# https://github.com-blaz-r/pi_pico_neopixel
# For testing purpose it was easier to put also the working code into this
# file, also for running this piece of code directly on the Pi Pico
# if split into two files, add 'from neopixel import Neopixel' to the imports
numpix = 192
strip = Neopixel(numpix, 0, 5, "RGBW")
